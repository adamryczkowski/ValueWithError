...
from ValueWithError import make_ValueWithError_from_vector, CI_95, CI_any, make_ValueWithError
...
def test_basic():
    ...
    assert repr(a.CI95)# Prints: CI_95%: (0.72, 1.28) - a bigger interval because of the smaller N
